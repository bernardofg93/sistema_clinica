...
<page pageset='new' backtop="10mm" backbottom="10mm" backleft="" backright="">
    ...
    <p>
        ...
        paciente <?= $data->nombre_pa ?> <?= $data->apellido_paterno_pa ?> <?= $data->apellido_materno_pa ?> que ingresa
        a la unidad de
        internamiento, el día <?= $data->fecha_ingreso ?> en punto de las <?= $data->hora_ingreso ?> está de acuerdo con
        lo siguiente:
    </p>
    <p>
